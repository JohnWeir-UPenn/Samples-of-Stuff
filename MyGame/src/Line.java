...
public class Line extends GameObj {
	public static final String img_file = "red.jpg";
	...
	public Line(int courtWidth, int courtHeight) {
		super(INIT_VEL_X, INIT_VEL_Y, INIT_X, INIT_Y, 
				10*SIZE, 1, courtWidth,
				courtHeight);
		try {
			if (img == null) {
			...
			System.out.println("Internal Error1:" + e.getMessage());
		}
	}
