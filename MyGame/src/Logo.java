...
public class Logo extends GameObj {
	public static final String img_file = "thelogo.jpg";
	...
	public Logo(int courtWidth, int courtHeight) {
		super(INIT_VEL_X, INIT_VEL_Y, INIT_X, INIT_Y, 
				775, 175, courtWidth, courtHeight);
		try {
			if (img == null) {
