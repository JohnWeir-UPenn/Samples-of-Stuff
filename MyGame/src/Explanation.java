...
public class Explanation extends GameObj {
	public static final String img_file = "intropicture.png";
	public static final int INIT_X = 0;
	public static final int INIT_Y = 175;
	public static final int INIT_VEL_X = 0;
	public static final int INIT_VEL_Y = 0;

	private static BufferedImage img;

	public Explanation(int courtWidth, int courtHeight) {
		super(INIT_VEL_X, INIT_VEL_Y, INIT_X, INIT_Y, 
				760, 425, courtWidth, courtHeight);
		try {
			if (img == null) {
				img = ImageIO.read(new File(img_file));
			}
		} catch (IOException e) {
			System.out.println("Internal Error4:" + e.getMessage());
		}
	}
